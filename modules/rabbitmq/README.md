...
module "rabbitmq_security_group" {
  source  = "git::git@github.com:quarks-labs/aws-security-group-module.git//modules/rabbitmq"
...
| <a name="input_auto_ingress_rules"></a> [auto\_ingress\_rules](#input\_auto\_ingress\_rules) | List of ingress rules to add automatically | `list(string)` | <pre>[<br>  "rabbitmq-4369-tcp",<br>  "rabbitmq-5671-tcp",<br>  "rabbitmq-5672-tcp",<br>  "rabbitmq-15672-tcp",<br>  "rabbitmq-25672-tcp"<br>]</pre> | no |
